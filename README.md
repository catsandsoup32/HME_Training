...
Run locally in `draw.py` file after running `pip install -r requirements.txt` and ensuring LaTeX is installed. Also can check out https://github.com/catsandsoup32/TeXan, an ongoing attempt to deploy the model as a Chrome Extension.
