...
from data.parser import render_from_strokes
...
if USE_SIMPLE:
    ...
    model.load_state_dict(torch.load(r'C:\Users\edmun\Desktop\VSCode Projects\HME_Training\runs\Exp8E15End_Acc=0.6744208335876465.pt', map_location=device, weights_only=True))
else:
...
class Paint(object):
    ...
    def paint(self, event):
        ...
        self.old_x = event.x
        self.old_y = event.y
        x, y, t = self.old_x, self.old_y, time.time()
